...
bool ModeTTWStabilize::_enter()
{
    quadplane.throttle_wait = false;
    return true;
}

void ModeTTWStabilize::update()
{
...
void ModeTTWStabilize::set_tailsitter_roll_pitch(const float roll_input, const float pitch_input)
{
...
void ModeTTWStabilize::set_limited_roll_pitch(const float roll_input, const float pitch_input)
{
