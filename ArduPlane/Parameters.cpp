...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Param: Tilt_wing_yaw_max
    // @DisplayName: tilt wing yaw max
    // @Description: maximum wing deflection for yaw input
    // @Units: deg
    // @Range: 0 20
    // @Increment: 0.01
    // @User: Standard
    GSCALAR(twing_yaw_max,     "TWING_YAW_MAX",  10),
